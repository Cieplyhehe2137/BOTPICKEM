...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('export_picks_fullplus')
    .setDescription('Eksportuj typy Full + Playoffs'),
  ...
  async execute(interaction) {
    ...
    const sheet = workbook.addWorksheet('Full + Playoffs Typy');
    ...
    await interaction.reply({
      files: [{ attachment: buffer, name: 'full_plus_playoffs_typy.xlsx' }],
      ephemeral: true,
    });
  },
};
